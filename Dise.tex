...
Estos se obtienen a partir de los planes analizados anteriormente, proyectando el plan para cada simbolo de la parte derecha de la regla. La importancia de estos planes radica en la contruccion de las secuencias de visita y ademas en el algoritmo principal de evaluacion en la generacion de codigo.
\begin{figure}\centering
