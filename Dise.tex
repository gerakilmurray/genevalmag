...
\begin{lstlisting}[numbers=left, firstnumber=8, language=specmag, linewidth=12cm]
...
semantic domain
  sort ecuacion, lista;
...
\lstinputlisting[basicstyle=\tiny, numbers=left, language=c++]{input_file_code/Node.hpp}

\lstinputlisting[basicstyle=\tiny, numbers=left, language=c++]{input_file_code/Plan.hpp}
