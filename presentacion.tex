...
\frame{
    ...
    \begin{itemize}
    \item Grafos \textbf{DP}: Dependencias directas de cada produccion.
    \item Grafos \textbf{Down}: Dependencias entre atributos de cada simbolo.
    \item Grafos \textbf{DCG}: Dependencias entre atributos de cada simbolos acotado a una producción.
    \item Grafos \textbf{ADP}: Grafos de dependecias aumentadas.
    \end{itemize}
    \begin{block}{}
...
\frame{
        ...
        \begin{block}{Algoritmo \textbtt{compute\_plans}}
            \begin{itemize}
                ...
                \item Generación de planes y planes projectados de evaluación.
            \end{itemize}
        \end{block}

    \begin{exampleblock}{Plan de evaluación}
        Lista de números de ecuaciones a computar, dirigiendo la evaluación de izquierda a derecha.
    \end{exampleblock}
    
    \begin{exampleblock}{Plan de evaluación proyectado}
...
\frame{
    ...
    \begin{itemize}
        \item Cálculo de los planes esta dado sobre los grafos ADP.
        \item 
        \item Orden topológico sobre el grafo ADP obtenido.
posibles
...
\begin{block}{}
\begin{itemize}
\item Traduccion de planes de evaluacion a secuancia de visita: \textbtt{compute}, \textbtt{visit}, \textbtt{leave}.
\item Se basa en la aplicacion de una simulación recorriendo los planes de evaluación.
\end{itemize}
\end{block}

\begin{center}\includegraphics[width=150px, height=80px]{./plan2seq.png}\end{center}
