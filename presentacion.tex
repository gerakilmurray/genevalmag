...
\begin{itemize}
\item Archivos Node.hpp, Node.cpp, $<eval>.cpp$, $<eval>.hpp$
...
\item Carpeta \textbf{graph}, que contiene subcarpetas con los tipos de grafos contruidos.
