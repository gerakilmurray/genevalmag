...
Razón por la cual \maggen\ genera un evaluador estático y debido a esto no se profundizará demasiado en este tipo de evaluadores.
...
En la sección \ref{sec:algevalattr} se presentarán los algoritmos \texttt{eval} y \texttt{traverse}, teniendo en cuenta heurísticas utilizadas por Wuu Yang en \cite{wuu-yang1}.
