...
Eval_mag::Eval_mag()
{
    ...
    unsigned short __context_key_plan_proj_1[] = {1,4,2,5};
    ...
    key_proj_1.node_project = "Y";
    key_proj_1.index_ocurrence = 1;
    unsigned short __order_eq_proj_1[] = {6,5};
    ...
    key_proj_2.node_project = "Z";
    key_proj_2.index_ocurrence = 2;
    unsigned short __order_eq_proj_2[] = {10};
    ...
    key_proj_3.node_project = "X";
    key_proj_3.index_ocurrence = 0;
    unsigned short __order_eq_proj_3[] = {9};
    ...
    unsigned short __context_key_plan_proj_4[] = {1,4,3,5};
    ...
    unsigned short __order_eq_proj_4[] = {7,8};
    ...
    unsigned short __context_key_plan_proj_5[] = {1,4,3,5};
    ...
    key_proj_5.node_project = "Z";
    key_proj_5.index_ocurrence = 2;
    unsigned short __order_eq_proj_5[] = {10};
    ...
    unsigned short __context_key_plan_proj_6[] = {5,2};
    ...
    unsigned short __key_order_eq_key_plan_proj_6[] = {10};
    ...
    key_proj_6.node_project = "Y";
    key_proj_6.index_ocurrence = 0;
    unsigned short __order_eq_proj_6[] = {5,6};
    ...
    unsigned short __context_key_plan_proj_7[] = {5,3};
    ...
    unsigned short __key_order_eq_key_plan_proj_7[] = {10};
    ...
    key_proj_7.node_project = "Y";
    key_proj_7.index_ocurrence = 0;
    unsigned short __order_eq_proj_7[] = {7,8};
...
void Eval_mag::traverse(struct Node * node, Order_eval_eq order)
{
    Key_plan k_plan;
...
void Eval_mag::compute_eq(int num_eq, struct Node *root)
{
    switch ( num_eq ) {
...
void Eval_mag::eval_visiter(struct Node *root)
{
...
void Eval_mag::evaluator_mag(struct Node *root)
{
