...
% \vspace{0.4cm}
\begin{flushleft}\texttt{``ERROR: ``E[1].syn\_1'' type synthetized, haven't an equation that defines it.''\\
\vspace{0.2cm}
``ERROR: ``S[0].inh\_1'' type inherited, is defined outside his scope.''\\
\vspace{0.2cm}
``ERROR: ``E[1].inh\_2'' type inherited, haven't an equation that defines it.''\\
\vspace{0.2cm}
``ERROR: ``S[0].syn\_2'' type synthetized, is defined outside his scope.''
}\end{flushleft}
