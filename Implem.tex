...
\begin{lstlisting}[float=t!, language=C++, basicstyle=\scriptsize, numbers=left]
my_grammar g;
...
\begin{lstlisting}[float=h!, language=C++, basicstyle=\scriptsize, numbers=left]
...
\begin{center}
\texttt{\textbf{vector<Expr\_instance> \&ins\_computed}}
\end{center}

\item [Planes Computados:] referencia a los planes de evaluación ya completados.
\begin{center}
\texttt{\textbf{vector< map<Key\_plan, unsigned short>::const\_iterator > \&plans\_computed}}
\end{center}

\item [Secuencias de Visita Computadas:] 
\begin{center}
\texttt{\textbf{vector<unsigned short> \&v\_seq\_computed}}
\end{center}
\end{description}
