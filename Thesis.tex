...
% 
% Gramáticas, Atributos, Multiplanes, AG, MAG, Generador, Evaluadores, C++, Estáticos\\
...
\include{Mag}         % Gramáticas de atributos multi-planes.
...
\include{performance} % medidas de performace
