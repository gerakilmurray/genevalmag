...
class Eval_mag
{
    ...
    public:
        Eval_mag()
        {
            ...
            Key_plan key_0;
            unsigned short __context_key_0[] = {1,2,1,1};
            ...
            Key_plan key_1;
            unsigned short __context_key_1[] = {1,2,1,3};
            ...
            Key_plan key_2;
            unsigned short __context_key_2[] = {1,2,3,1};
            ...
            Key_plan key_3;
            unsigned short __context_key_3[] = {1,2,3,3};
            ...
            unsigned short __context_key_plan_proj_0[] = {1,2,1,1};
            ...
            key_proj_0.node_project = "T2";
            key_proj_0.index_ocurrence = 0;
            unsigned short __order_eq_proj_0[] = {2};
            ...
            unsigned short __context_key_plan_proj_1[] = {1,2,1,3};
            ...
            key_proj_1.node_project = "T2";
            key_proj_1.index_ocurrence = 0;
            unsigned short __order_eq_proj_1[] = {2};
            ...
            unsigned short __context_key_plan_proj_2[] = {1,2,3,1};
            ...
            unsigned short __context_key_plan_proj_3[] = {1,2,3,3};
            ...
            unsigned short __context_key_plan_proj_4[] = {1,2,1,1};
            ...
            key_proj_4.node_project = "T";
            key_proj_4.index_ocurrence = 1;
            unsigned short __order_eq_proj_4[] = {1};
            ...
            unsigned short __context_key_plan_proj_5[] = {1,2,1,3};
            ...
            key_proj_5.node_project = "T";
            key_proj_5.index_ocurrence = 1;
            unsigned short __order_eq_proj_5[] = {1};
            ...
            unsigned short __context_key_plan_proj_6[] = {1,2,3,1};
            ...
            key_proj_6.node_project = "T";
            key_proj_6.index_ocurrence = 1;
            unsigned short __order_eq_proj_6[] = {3};
            ...
            unsigned short __context_key_plan_proj_7[] = {1,2,3,3};
            ...
            key_proj_7.node_project = "T";
            key_proj_7.index_ocurrence = 1;
            unsigned short __order_eq_proj_7[] = {3};
            ...
            Key_plan key_plan_proj_8;
            unsigned short __context_key_plan_proj_8[] = {1,2,1,1};
            Order_rule context_key_plan_proj_8(__context_key_plan_proj_8, __context_key_plan_proj_8 + sizeof(__context_key_plan_proj_8) / sizeof(unsigned short));
            key_plan_proj_8.id_plan = context_key_plan_proj_8;
            unsigned short __key_order_eq_key_plan_proj_8[] = {1};
            Order_eval_eq key_order_eq_key_plan_proj_8(__key_order_eq_key_plan_proj_8, __key_order_eq_key_plan_proj_8 + sizeof(__key_order_eq_key_plan_proj_8) / sizeof(unsigned short));
            key_plan_proj_8.plan = key_order_eq_key_plan_proj_8;

            Key_plan_project key_proj_8;
            key_proj_8.id_plan_project = key_plan_proj_8;
            key_proj_8.node_project = "T";
            key_proj_8.index_ocurrence = 2;
            unsigned short __order_eq_proj_8[] = {1};
            Order_eval_eq order_eq_proj_8(__order_eq_proj_8, __order_eq_proj_8 + sizeof(__order_eq_proj_8) / sizeof(unsigned short));
            Plan_project __plan_proj_8(key_proj_8 , order_eq_proj_8);
            eval_plans_project.push_back(__plan_proj_8);

            Key_plan key_plan_proj_9;
            unsigned short __context_key_plan_proj_9[] = {1,2,1,3};
            Order_rule context_key_plan_proj_9(__context_key_plan_proj_9, __context_key_plan_proj_9 + sizeof(__context_key_plan_proj_9) / sizeof(unsigned short));
            key_plan_proj_9.id_plan = context_key_plan_proj_9;
            unsigned short __key_order_eq_key_plan_proj_9[] = {1};
            Order_eval_eq key_order_eq_key_plan_proj_9(__key_order_eq_key_plan_proj_9, __key_order_eq_key_plan_proj_9 + sizeof(__key_order_eq_key_plan_proj_9) / sizeof(unsigned short));
            key_plan_proj_9.plan = key_order_eq_key_plan_proj_9;

            Key_plan_project key_proj_9;
            key_proj_9.id_plan_project = key_plan_proj_9;
            key_proj_9.node_project = "T";
            key_proj_9.index_ocurrence = 2;
            unsigned short __order_eq_proj_9[] = {3};
            Order_eval_eq order_eq_proj_9(__order_eq_proj_9, __order_eq_proj_9 + sizeof(__order_eq_proj_9) / sizeof(unsigned short));
            Plan_project __plan_proj_9(key_proj_9 , order_eq_proj_9);
            eval_plans_project.push_back(__plan_proj_9);

            Key_plan key_plan_proj_10;
            unsigned short __context_key_plan_proj_10[] = {1,2,3,1};
            Order_rule context_key_plan_proj_10(__context_key_plan_proj_10, __context_key_plan_proj_10 + sizeof(__context_key_plan_proj_10) / sizeof(unsigned short));
            key_plan_proj_10.id_plan = context_key_plan_proj_10;
            unsigned short __key_order_eq_key_plan_proj_10[] = {1};
            Order_eval_eq key_order_eq_key_plan_proj_10(__key_order_eq_key_plan_proj_10, __key_order_eq_key_plan_proj_10 + sizeof(__key_order_eq_key_plan_proj_10) / sizeof(unsigned short));
            key_plan_proj_10.plan = key_order_eq_key_plan_proj_10;

            Key_plan_project key_proj_10;
            key_proj_10.id_plan_project = key_plan_proj_10;
            key_proj_10.node_project = "T";
            key_proj_10.index_ocurrence = 2;
            unsigned short __order_eq_proj_10[] = {1};
            Order_eval_eq order_eq_proj_10(__order_eq_proj_10, __order_eq_proj_10 + sizeof(__order_eq_proj_10) / sizeof(unsigned short));
            Plan_project __plan_proj_10(key_proj_10 , order_eq_proj_10);
            eval_plans_project.push_back(__plan_proj_10);

            Key_plan key_plan_proj_11;
            unsigned short __context_key_plan_proj_11[] = {1,2,3,3};
            Order_rule context_key_plan_proj_11(__context_key_plan_proj_11, __context_key_plan_proj_11 + sizeof(__context_key_plan_proj_11) / sizeof(unsigned short));
            key_plan_proj_11.id_plan = context_key_plan_proj_11;
            unsigned short __key_order_eq_key_plan_proj_11[] = {1};
            Order_eval_eq key_order_eq_key_plan_proj_11(__key_order_eq_key_plan_proj_11, __key_order_eq_key_plan_proj_11 + sizeof(__key_order_eq_key_plan_proj_11) / sizeof(unsigned short));
            key_plan_proj_11.plan = key_order_eq_key_plan_proj_11;

            Key_plan_project key_proj_11;
            key_proj_11.id_plan_project = key_plan_proj_11;
            key_proj_11.node_project = "T";
            key_proj_11.index_ocurrence = 2;
            unsigned short __order_eq_proj_11[] = {3};
            Order_eval_eq order_eq_proj_11(__order_eq_proj_11, __order_eq_proj_11 + sizeof(__order_eq_proj_11) / sizeof(unsigned short));
            Plan_project __plan_proj_11(key_proj_11 , order_eq_proj_11);
            eval_plans_project.push_back(__plan_proj_11);

            Key_plan key_plan_proj_12;
            unsigned short __context_key_plan_proj_12[] = {1,2,1,1};
            Order_rule context_key_plan_proj_12(__context_key_plan_proj_12, __context_key_plan_proj_12 + sizeof(__context_key_plan_proj_12) / sizeof(unsigned short));
            key_plan_proj_12.id_plan = context_key_plan_proj_12;
            unsigned short __key_order_eq_key_plan_proj_12[] = {1};
            Order_eval_eq key_order_eq_key_plan_proj_12(__key_order_eq_key_plan_proj_12, __key_order_eq_key_plan_proj_12 + sizeof(__key_order_eq_key_plan_proj_12) / sizeof(unsigned short));
            key_plan_proj_12.plan = key_order_eq_key_plan_proj_12;

            Key_plan_project key_proj_12;
            key_proj_12.id_plan_project = key_plan_proj_12;
            key_proj_12.node_project = "T2";
            key_proj_12.index_ocurrence = 0;
            unsigned short __order_eq_proj_12[] = {2};
            Order_eval_eq order_eq_proj_12(__order_eq_proj_12, __order_eq_proj_12 + sizeof(__order_eq_proj_12) / sizeof(unsigned short));
            Plan_project __plan_proj_12(key_proj_12 , order_eq_proj_12);
            eval_plans_project.push_back(__plan_proj_12);

            /**
              * Initialize of Visit Sequences.
              */

            int __order_0[] = {1,2,3,-1};
            Visit_sequence order_0(__order_0, __order_0 + sizeof(__order_0) / sizeof(int));
            v_seq.push_back(order_0);

            int __order_1[] = {1,2,3,-1};
            Visit_sequence order_1(__order_1, __order_1 + sizeof(__order_1) / sizeof(int));
            v_seq.push_back(order_1);

            int __order_2[] = {1,2,3,-1};
            Visit_sequence order_2(__order_2, __order_2 + sizeof(__order_2) / sizeof(int));
            v_seq.push_back(order_2);

            int __order_3[] = {1,2,3,-1};
            ...
            string __rule_non_terminal_0[] = {"T","T2","T","T"};
        ...
        // Eq (1) T[0].longi = ((T2[0].longi + T[1].longi) + T[2].longi);
        void compute_eq_1(struct Node *root)
        {
            T *node((T*) root);
            node->longi = ((((T2*)node->childs[0])->longi + ((T*)node->childs[1])->longi) + ((T*)node->childs[2])->longi);
        }
