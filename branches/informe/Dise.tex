...
\end{enumerate} 
\begin{figure}\centering
\includegraphics[width=249pt,height=586pt]{simu.png}
...
La etapa final de \maggen\ esta dado por la generación de código para el evaluador estático. Como hemos analizado en el diagrama visto en la figura \ref{fig:disen}, esta etapa se realiza en el paquete ``Builder'', específicamente en el modulo \texttt{Builder\_code}.
...
A continuación abordaremos algunas consideraciones sobre la generación de código en \maggen.
