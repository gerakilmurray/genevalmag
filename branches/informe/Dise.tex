...
\newpage
El resultado del ejemplo, aplicando los pasos tratados arriba, es tratado en el siguiente diagrama:
\begin{center}
...
\tiny
\lstinputlisting[numbers=left, numberstyle=\tiny, numbersep=5pt, language=c++]{input_file_code/Node.hpp}

\tiny
\lstinputlisting[numbers=left, numberstyle=\tiny, numbersep=5pt, language=c++]{input_file_code/Plan.hpp}
\normalsize