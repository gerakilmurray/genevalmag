...
\begin{lstlisting}[float, language=C++, basicstyle=\scriptsize, columns=fullflexible, linewidth=13cm]
...
\item Reglas:
\begin{lstlisting}[language=C++,basicstyle=\scriptsize,columns=fullflexible,columns=fullflexible,linewidth=9cm]
...
\begin{items}
\item \texttt{traverse}: responsable de selecionar el plan de evaluación para cada nodo no terminal.
\end{items}
