...
Tal como lo presenta Wuu-Yang en \cite{wuu-yang1} y como lo analizamos en el capitulo anterior (Ver sec. \ref{sec:gramNC} y \ref{sec:relfamag}), la familia de \textit{gramática de atributos multi-planes} es una clase que se encuentra dentro de las WDAG y dentro de ellas de las NC.
