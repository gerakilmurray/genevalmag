...
Para compilar e instalar \maggen, primero el usuario deberá posicionarse dentro del directorio ``\textbtt{maggen/}'', mediante las funciones de la terminal, y luego deberá ejecutar los siguientes comandos:
...
\item Archivos usados por \textbtt{automake} y \textbtt{autoconf} para generar los archivos \textbtt{Makefile} y el script \textbtt{configure} que permiten automatizar el proceso de compilación, empaquetado e instalación del proyecto.
\end{itemize}
