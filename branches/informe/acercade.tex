...
El evaluador generado por \maggen\ recibe un \textbf{AST} y devuelve este \textbf{AST de\-corado}. El potencial del evaluador generado por \maggen, esta dado, por tener estáticamente todas las posibles secuencias de visita para los posibles \textbf{AST} de entrada, entonces sólo debe seleccionar las secuencias para el AST dado y luego recorrerlo según como las mismas lo indiquen.
...
\textit{Notar que, el mensaje de error indicará la ruta donde fueron almacenados los grafos con problemas de ciclicidad. En este ejemplo, la variable \textbtt{path\_output}, fue seteada con un valor por defecto, pero el usuario puede proporcionar otra la ruta al momento del uso de la herramienta. Ver \ref{sec:uso-maggen} para más detalles.}\\
