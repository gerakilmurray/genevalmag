...
\frame{
    ...
    \begin{exampleblock}{Gramática de Atributos Multiplanes}
...
\frame{
    ...
    Basa su funcionamiento en la visita de los nodos de los árboles de derivación para lograr la evaluación del árbol. Este método se apoya en los planes de evaluación de la gramática.
}
...
\frame{
    ...
    \begin{itemize}
        \item Se mantiene una cola de trabajos con pares de identificador de producción y un ordén de evalución de sus atributos.
        \pause
...
\frame{
\frametitle{Algoritmo de evalución}
...
\frame{
	...
	Implementar Lenguajes de Prop\'ositos Espec\'ificos para problemas puntuales.
    \end{block}
}
...
\frame{
    ...
    \begin{block}{Ejemplo Aritmetica de expresiones}
        ...
        \begin{tabular}{|l||c|c|}
            ...
            \textbf{Cant. de planes}           & 371                        & 371                         \\ \hline
            \textbf{Cant. de planes proy.}     & 687                        & 687                         \\ \hline
            \textbf{Cant. de sec. de visita }  & \color{red}371             & \color{blue}22              \\ \hline
            \textbf{Generación del evaluador}  & \color{red} $\sim$1.44 sec & \color{blue} $\sim$0.47 sec \\ \hline
			\textbf{Cant. de líneas (eval.)}   & \color{red}17464           & \color{blue}5974            \\ \hline
        \end{tabular}
        \end{center}
        \end{figure}
    \end{block}
...
\frametitle{Medidas de performance: Versión de Boost}
    ...
    \begin{block}{Tiempos de generación de evaluadores de \maggen}
        ...
        \begin{tabular}{|l||c|c|}
            \hline
            \rowcolor{gris}
            Input / Spirit           & \textbf{1.8x}   & \textbf{2.1}    \\ \hline
            \textbtt{MAG Wuu Yang}   & $\sim$0.087 sec & $\sim$0.084 sec \\ \hline
            \textbtt{MAG Aritmetica} & $\sim$0.590 sec & $\sim$0.470 sec \\ \hline
        \end{tabular}
        \end{center}
        \end{figure}
...
\frame{
    ...
    \begin{block}{Tiempos de compilación del evaluador generado}
        ...
        \begin{tabular}{|l||c|c|}
            \hline
            \rowcolor{gris}
            Input / g++          & \textbf{sin -O3} & \textbf{con -O3}             \\ \hline
            \textbtt{Wuu Yang}   & $\sim$1.51 sec   & $\sim$2.55 sec               \\ \hline
            \textbtt{Aritmetica} & $\sim$5.98 sec   & \textbf{$\sim$1 min 5.6 sec} \\ \hline
        \end{tabular}
        \end{center}
        \end{figure}
    \end{block}
    ...
    \begin{block}{Tamaños del ejecutable del evaluador generado}
        ...
        \begin{tabular}{|l||c|c|}
            ...
            \rowcolor{gris}
            Input / g++          & \textbf{sin -O3} & \textbf{con -O3} \\ \hline
            \textbtt{Wuu Yang}   & 104 Kb           & \ 48 Kb          \\ \hline
            \textbtt{Aritmetica} & 516 Kb           & 384 Kb           \\ \hline
        \end{tabular}
        \end{center}
        \end{figure}
    \end{block}
