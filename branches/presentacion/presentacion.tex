...
\frame{
    ...
    \begin{alertblock}{Gramática de Atributos Multiplanes}
...
\frame{
    ...
    \begin{center}
        ``Los planes proyectados juegan el rol de orden de evaluación impuesto como contexto superior.''
    \end{center}
}
...
\frame{
  ...
  \begin{block}{}
    \begin{itemize}
      ...
      \item Se basa en la aplicación de una simulación recorriendo los planes de evaluación buscando las dependencias.
    \end{itemize}
  \end{block}
