...
\frame{
\frametitle{Medidas de performance: Version de Boost}
\begin{block}{Ejemplo Wuu Yang}
\begin{tabular}{|c|c|c|}
\hline
Conf.             & \textbf{Boost 1.37} & \textbf{Boost 1.43} \\ \hline
\textbtt{g++}     & 1                   & 3                   \\ \hline
\textbtt{g++ -O3} & 2                   & 4                   \\ \hline
\end{tabular}
\end{block}
}

\frame{
\frametitle{Medidas de performance: Optimización de secuancias de visita}
\begin{block}{Ejemplo Aritmetica}
\begin{tabular}{|c|c|c|}
\hline
Conf.             & \textbf{Boost 1.37} & \textbf{Boost 1.43} \\ \hline
\textbtt{g++}     & 1                   & 3                   \\ \hline
