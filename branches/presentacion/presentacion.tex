...
\frame{
    ...
    Los grafos ADP, generados, son la entrada para la construcción de \textbf{planes de evaluación}.
...
\frame{
    ...
    \begin{itemize}
        ...
        \item Cada símbolo de la gramática es implementado mediante \texttt{structs} de C++.
...
\subsection{Usando magGen}

\frame{
    \frametitle{Usando \maggen}
    \begin{block}{}
     Luego de la instalación, \maggen\ puede ser invocado desde la linea de comandos.
    \end{block}
...
\frame{
    ...
    \begin{itemize}
        ...
        \vspace{0.1cm}
        \pause
        \item Se construye el AST de entrada a evaluar en un archivo C++, junto con la función \texttt{main} invocando la evaluación
        \pause
        \item Se ejecuta el binario para lograr los resultados.
    \end{itemize}
...
\begin{itemize}
\item Archivos \textbf{Node.hpp}, \textbf{Node.cpp}, $\langle \textbf{eval}\rangle.\textbf{cpp}$, $\langle \textbf{eval}\rangle.\textbf{hpp}$
...
\pause
Tanto los planes como los grafos son generados en formato \texttt{dot}. Los mismo pueden ser convertido a imagen (png) utilizando el script que se encuentra en el paquete de la herramienta. 
...
\frame{
    ...
    \begin{exampleblock}{}
        En la mayoría de los casos la explosión de planes se producía por la cantidad de contextos: \textbf{Planes repetidos}
    \end{exampleblock}
\pause
    \begin{block}{}
        \begin{itemize}
