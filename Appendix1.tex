...
\end{lstlisting}
\section{Codigo generado por \maggen: Ejemplo Wuu Yang.}
...
\tiny
\lstinputlisting[numbers=left, numberstyle=\tiny, numbersep=5pt, language=c++]{input_file_code/maggen.hpp}
\subsection*{Archivo implementación: \texttt{maggen.cpp}}
\tiny
\lstinputlisting[numbers=left, numberstyle=\tiny, numbersep=5pt, language=c++]{input_file_code/maggen.cpp}
