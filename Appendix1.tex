...
\lstinputlisting[basicstyle=\scriptsize, numbers=left, columns=fullflexible, language=specmag]{input_file_code/Grammar_mag_wuu.log}
...
\subsubsection{Archivo de input: \textbtt{ag\_aritmetic.input}}
\lstinputlisting[basicstyle=\scriptsize, numbers=left, columns=fullflexible, language=specmag]{input_file_code/ag_aritmetic.input}

\subsubsection{Archivo de output: \textbtt{Grammar\_mag.log}}
\lstinputlisting[basicstyle=\scriptsize, numbers=left, columns=fullflexible, language=specmag]{input_file_code/Grammar_mag_arit.log}
...
\begin{figure}[!ht]\centering
\includegraphics[width=450pt, height=441pt]{diagramas/arquitectura_simple.png}
